...
## Key Features
- **Question bank** — questions loaded and randomized from a local dataset
- **MCQ-based gameplay** — multiple choice answer selection
- Countdown timer per question — auto-advances to the next question if no answer is selected
- Score increases on correct answers; correct option highlights green
- Score-oriented progression system
